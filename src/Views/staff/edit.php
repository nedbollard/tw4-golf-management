...
<div class="staff-form-layout">
    ...
    <main>
        <div class="staff-form-card">
            <h2 class="staff-form-card-title"><?php echo htmlspecialchars($app_title); ?> Edit Staff Member</h2>
            <div class="staff-form-card-body">
                ...
                <form method="POST" action="/staff/update/<?php echo $staff->getStaffId(); ?>">
                    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token); ?>">
                    <div class="mb-3">
                        <label for="first_name" class="form-label">First Name</label>
                        <input type="text" class="form-control" id="first_name" name="first_name"
                               value="<?php echo htmlspecialchars($old['first_name'] ?? $staff->getFirstName()); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="last_name" name="last_name"
                               value="<?php echo htmlspecialchars($old['last_name'] ?? $staff->getLastName()); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="username" name="username"
                               value="<?php echo htmlspecialchars($old['username'] ?? $staff->getUsername()); ?>" required>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="role" name="role" required>
                                <option value="admin" <?php echo (($old['role'] ?? $staff->getRole()) === 'admin') ? 'selected' : ''; ?>>Admin</option>
                                <option value="scorer" <?php echo (($old['role'] ?? $staff->getRole()) === 'scorer') ? 'selected' : ''; ?>>Scorer</option>
                            </select>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn-action-primary">Update Staff Member</button>
                    </div>
                </form>
            </div>
        </div>
